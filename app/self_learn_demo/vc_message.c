...
#if defined(CONFIG_APP_SLD_APP_VC2_UART_MESSAGE_QUERY_SUPPORTED) || defined(CONFIG_APP_VC2_HW_I2C)
...
#if defined(MESSAGE_UART) || defined(CONFIG_APP_SLD_APP_VC2_HW_I2C)
typedef struct
{
...
{
    printf("[%s]%d\n", __func__, __LINE__);
#ifdef CONFIG_APP_SLD_APP_VC2_UART_MESSAGE_QUERY_SUPPORTED
...
#ifdef CONFIG_APP_SLD_APP_VC2_HAS_MESSAGE_NOTIFY_PIN
static void _gpioMessageInit(void)
{
    gx_gpio_set_level(CONFIG_APP_SLD_APP_VC2_MESSAGE_NOTIFY_PIN_ID, GX_GPIO_LEVEL_HIGH);
    gx_gpio_set_direction(CONFIG_APP_SLD_APP_VC2_MESSAGE_NOTIFY_PIN_ID, GX_GPIO_DIRECTION_OUTPUT);
}

static void _gpioMessageNotify(void)
{
    gx_gpio_set_level(CONFIG_APP_SLD_APP_VC2_MESSAGE_NOTIFY_PIN_ID, GX_GPIO_LEVEL_LOW);
    gx_mdelay(60);
    gx_gpio_set_level(CONFIG_APP_SLD_APP_VC2_MESSAGE_NOTIFY_PIN_ID, GX_GPIO_LEVEL_HIGH);
}
#endif

#ifdef CONFIG_APP_SLD_APP_VC2_HW_I2C
...
{
#ifdef CONFIG_APP_SLD_APP_VC2_HAS_MESSAGE_NOTIFY_PIN
    printf (LOG_TAG"NOTIFY PIN %d\n", CONFIG_APP_SLD_APP_VC2_MESSAGE_NOTIFY_PIN_ID);
    _gpioMessageInit();
#endif
...
#ifdef CONFIG_APP_SLD_APP_VC2_UART_MESSAGE_NOTIFY_SUPPORTED
